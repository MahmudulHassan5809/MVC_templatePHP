...
.adminleft{max-width: 200px; float: left;margin-right: 10px;padding-right: 10px;border-right: 1px solid #ddd;}
.widget{margin-bottom: 20px;}
.widget h3{background: #3399ff;border-bottom:2px solid #066cd2;color: #000;
 margin: 0 0 2px; padding:5px;text-shadow: 0 1px 1px #fff;}
.widget ul{margin: 0px; padding: 0;list-style: none;}
.widget ul li{display: block;}
.widget ul li a{background: #ddd;border-bottom: 1px solid #fff;
color:#000;display: block;padding: 5px 10px;text-decoration: none;}
.widget ul li a:hover{background: #bebebe;}
.adminright{width:585px;float:right;padding: 5px 10px;background: #fafafa;}
.adminright h2{border-bottom: 2px dashed #666;
color: #666;margin:0 0 10px;padding-bottom: 10px;}
</style>
</head>
<body>
